...
The title comes from James Joyce's _Finnegans Wake_—a playful line that physicist Murray Gell-Mann borrowed in 1964 when he needed a name for something that shouldn't exist: particles with fractional electric charge.
...
In the 1780s, Antoine Lavoisier showed that matter transforms but never vanishes—combustion was oxygen combining with fuel, not something escaping. A century and a half later, Linus Pauling revealed _why_ atoms bond the way they do, applying quantum mechanics to show that bonds arise from electrons shared between atoms.
...
### Human Frame (10^-2 to 10^0 Meters)
...
### The Valley Quilt (10^3 Meters, 1 Kilometer)
...
### Continental Puzzle (10^6 Meters)
...
### Inner Planets (10^9 to 10^11 Meters)
...
### The Outer Planets & Heliopause (10^13 Meters)
...
### Closest Neighbors (10^16 to 10^17 Meters)
